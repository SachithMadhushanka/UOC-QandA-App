...
public class EditProfileActivity extends AppCompatActivity {
    ...
    com.example.uocqaapp.databinding.ActivityEditProfileBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.example.uocqaapp.databinding.ActivityEditProfileBinding.inflate(getLayoutInflater());
