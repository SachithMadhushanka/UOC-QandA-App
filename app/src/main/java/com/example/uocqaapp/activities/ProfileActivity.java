...
public class ProfileActivity extends AppCompatActivity {
    ...
    com.example.uocqaapp.databinding.ActivityProfileBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = com.example.uocqaapp.databinding.ActivityProfileBinding.inflate(getLayoutInflater());
